...
export class SprotBorderValues{
    ...
    createUi(){
        ...
        const numEntry = new SprotNumericEntry(td1, top, 20, "Border top");
        const numEntry2 = new SprotNumericEntry(td2, right, 20, "Border right");
        const numEntry3 = new SprotNumericEntry(td3, bottom, 20, "Border bottom");
        const numEntry4 = new SprotNumericEntry(td4, left, 20, "Border left");
